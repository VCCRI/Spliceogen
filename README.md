...
## Getting Started
See here for installation instructions and required files. Ensure (dependencies)[#spliceogen-dependencies] are met, or alternatively, run Spliceogen from the provided (docker)[##docker] image.
### Installation:
